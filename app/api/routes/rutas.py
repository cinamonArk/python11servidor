...
#GastoDTOPeticion,GastoDTORespuesta,CategoriaDTOPeticion,CategoriaDTORespuesta,MetodoPagoDTOPeticion,MetodoPagoDTORespuesta,FacturaDTOPeticion,FacturaDTORespuesta
from app.api.models.modelosApp import Usuario
#Gastos,Categoria,MetodoPago,Factura
